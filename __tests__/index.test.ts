...
describe('Pure Functions LTV Calculator', () => {
  describe('LTV', () => {
    it('If Sales is 100, User is 10, and Churn rate is 10%. The LTV is 100', () => {
      const arpu = calculateARPU(100, 10)
      const averageDuration = calculateAverageDuration(10)
      const ltv = calculateLTV(arpu, averageDuration)
      expect(ltv).toEqual(100)
    })
  })
  describe('ARPU', () => {
  ...
  describe('Average Duration', () => {
    ...
    it('If churn rate is 10%, The average duration should be 10', () => {
      const averageDuration = calculateAverageDuration(10, 'percentage')
      expect(averageDuration).toEqual(10)
    })
    it('If churn rate is 0.1, The average duration should be 10', () => {
      const averageDuration = calculateAverageDuration(0.1, 'number')
      expect(averageDuration).toEqual(10)
    })
  })
  describe('MRR/ARR', () => {
  ...
  describe('Churn Rate', () => {
    it('Should calculate customer churn rate correctly', () => {
      ...
      const churnRate = calculateCustomerChurnRate(input)
    ...
    it('Should calculate revenue churn rate correctly', () => {
      ...
      const churnRate = calculateRevenueChurnRate(input)
  ...
  describe('Cohort Retention', () => {
    it('Should calculate cohort retention correctly', () => {
      ...
      const retention = calculateCohortRetention(cohorts)
  ...
  describe('Historical LTV', () => {
    it('Should calculate historical LTV correctly', () => {
      ...
      const ltv = calculateHistoricalLTV(revenues)
      expect(ltv).toEqual(1300)
    })
    it('Should return 0 for empty array', () => {
      const ltv = calculateHistoricalLTV([])
